              ...
              <div className="glass-card">
                ...
                <div className="release-section">
                  <div className="release-header">
                    <h3 className="release-title">Android Patch - {release.name}</h3>
                    <span className="release-meta"> Uploaded on {new Date(release.published_at).toLocaleDateString('en-US', {
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric'
                      })}
