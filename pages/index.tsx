      ...
      <Layout title="Error - Pixel Build Prop">
        <div className="min-h-screen flex items-center justify-center">
          <div className="max-w-md w-full bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">{props.error}</p>
            <button
  ...
  return (
    <Layout>
      ...
      >
        ...
        <Notes />
        {props.release && <ReleaseSection release={props.release} />}
...
export const getStaticProps: GetStaticProps<PageProps> = async () => {
  ...
  try {
    const [releasesResult, changelogResult, rateLimitResult] =
    ...
    console.log(`Static props generated in ${buildTime}ms`);
