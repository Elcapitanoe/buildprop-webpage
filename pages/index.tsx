...
const Home: React.FC<Props> = ({ changelog, release, rateLimit }) => {
    ...
    <div className="min-h-screen animated-bg">
      ...
      <div className="main-container">
        ...
        <footer className="footer-section content-section scroll-reveal">
          ...
          <p className="footer-subtext">
  GitHub API Limit:{' '}
  <span className={rateLimit.remaining < 100 ? 'text-red-600 font-semibold' : ''}>
...
const rateLimit = {
  ...
  reset: rateData.rate?.reset
    ...
    return {
      ...
      revalidate: 3600, // rebuild tiap 1 jam
    };
  } catch (error) {
