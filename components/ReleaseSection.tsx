    ...
    <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-8 animate-slide-up">
      <div className="flex items-start justify-between mb-6 pb-4 border-b border-gray-100">
        <div className="flex-1">
          <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-2 flex items-center gap-3">
            ...
            <div className="space-y-3">
              {release.assets.map((asset) => (
                <a
                  ...
                  className="flex items-center justify-between p-4 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
                  target="_blank"
